...
class UIConsola:
    ...
    if self.blackjack.casa_perdio():
        print("\nLA CASA HA PERDIDO. HAS GANADO EL JUEGO")
        self.blackjack.jugador.agregar_fichas(self.blackjack.apuesta * 2)
    elif self.blackjack.jugador.mano.calcular_valor() > self.blackjack.cupier.mano.calcular_valor():
        print("\nHAS GANADO EL JUEGO")
        self.blackjack.jugador.agregar_fichas(self.blackjack.apuesta * 2)
    elif self.blackjack.jugador.mano.calcular_valor() < self.blackjack.cupier.mano.calcular_valor():
        print("\nLA CASA HA GANADO. HAS PERDIDO EL JUEGO")
        self.blackjack.jugador.restar_fichas(self.blackjack.apuesta)
    else:
        print("\nEMPATE. SE DEVUELVEN LAS FICHAS")
        self.blackjack.jugador.agregar_fichas(self.blackjack.apuesta)
